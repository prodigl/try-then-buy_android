module.exports.handleRestRequest = async function handleRestRequest(
  actionFunction,
  { req, res }
) {
  try {
...
// LEARN MORE FROM: https://levelup.gitconnected.com/the-definite-guide-to-handling-errors-gracefully-in-javascript-58424d9c60e6
