...
const Demo = (props) => {
  ...
  const [catetype, setCateytype] = useState("childcategory_id");
          ...
          <>
                ...
                <div className="container-fluid px-4">
                  <nav>
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item">
                        <Link
                          href={`/category/${data.subcategory.category.slug}`}
                        >
                          <a>{data.subcategory.category.name}</a>
                        </Link>
                      </li>
                      <li className="breadcrumb-item">
                        <Link href={`/sub-category/${data.subcategory.slug}`}>
                ...
                <div className="container-fluid extra-container px-4">
                  <div className="slider-carosel">
                    {data?.subs?.map((value) => {
                      return (
                        <>
                          <Link href={`/sub_category/${value.slug}`}>
            ...
            <h1 className="font-18x mt-4">Top Selling Products</h1>
              ...
              <div className="container py-3 px-1">
                <Product id={data.id} category={"childcategory_id"} />
              </div>

              {/* Offer Section Area Start */}

              <div className="container-fluid px-0">
                <img src="/images/category.png" alt="" className="img-fluid" />
              </div>
